...
export default function TrendingQuizzesPage() {
  ...
  const fetchTrendingQuizzes = async () => {
    setIsLoading(true)
    try {
      const response = await fetch(`/api/quiz?sort=trending&timeframe=${timeframe}&limit=20`)
      if (response.ok) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <div className="text-xl font-semibold text-gray-700">Loading trending quizzes...</div>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Most popular quizzes right now on Quiz Squirrel
          </p>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-500 mb-6">
                Be the first to create a popular quiz!
              </p>
              <Button
                variant="primary"
              ...
              <Card key={quiz.id}>
                <CardContent className="p-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-orange-400 to-pink-600 flex items-center justify-center">
